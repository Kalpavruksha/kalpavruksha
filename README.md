...
<!-- Animated Header -->
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=58A6FF&center=true&vCenter=true&width=700&lines=Hey+there%2C+I'm+Kalpavruksha+%F0%9F%91%8B;Full+Stack+Developer+%7C+AI+Enthusiast;Building+products+that+matter+%F0%9F%9A%80" alt="Typing SVG" />

<br/>

<!-- Profile Views - single, clean -->
<img src="https://komarev.com/ghpvc/?username=Kalpavruksha&label=Profile+Views&color=0e75b6&style=flat" alt="Profile views" />
...
const Kalpavruksha = {
  ...
  education : "B.E. Computer Science — VTU (VIII Semester)",
  location  : "Karnataka, India 🇮🇳",
  email     : "kalpavruksha.g.dev@gmail.com",
  pronouns  : "He / Him",

  currentlyBuilding : [
    "AI-powered Portfolio Builder with Hosting",
    "Full Stack SaaS Applications",
  ],

  learning  : ["TypeScript", "GraphQL", "Advanced ML", "DevOps"],
  collab    : "Open Source Projects & Innovative Web Apps",

  superpower: "Turning complex problems into elegant, scalable solutions",
  motto     : "Code is poetry. AI is magic. Together — the impossible becomes real.",
};
```
...
|---|---|---|
| 🏗️ AI Portfolio Builder | Next.js · Django · Gemini API · Three.js | 🔨 Active |
| 🌐 Client Website (IBCC) | Next.js 15 · TypeScript · Tailwind · Vercel | ✅ Live |
| 🎨 Personal Portfolio | GSAP · Three.js · Lenis · Splitting.js | 🔨 Active |
...
<img src="https://github-readme-streak-stats.herokuapp.com/?user=Kalpavruksha&theme=tokyonight&hide_border=true" width="70%" alt="GitHub Streak"/>
...
hobbies:
  - 🎸  Guitar     — Rock & Blues
  - 🥋  Martial Arts — Karate practitioner
  - 🏊  Swimming
  - 📚  Reading     — Sci-fi & tech
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6&height=120&section=footer&text=Thanks+for+visiting!+Let%27s+build+something+great+%F0%9F%9A%80&fontSize=16&fontColor=fff&animation=fadeIn&fontAlignY=65"/>
</div>
